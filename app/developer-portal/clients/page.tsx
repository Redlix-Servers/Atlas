                    ...
                    <div className="space-y-2 mb-4">
                      {client.company && (
                        <p className="text-zinc-500 text-sm font-medium flex items-center gap-1.5">
                          <svg className="w-3.5 h-3.5 text-zinc-600" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" /></svg>
                          {client.company}
                        </p>
                      )}
                      {client.authorizedName && (
                        <p className="text-zinc-500 text-[11px] font-medium flex items-center gap-1.5 italic">
                          <svg className="w-3.5 h-3.5 text-zinc-600" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" /></svg>
                          Auth: {client.authorizedName}
                        </p>
                      )}
                    </div>
                  </div>
